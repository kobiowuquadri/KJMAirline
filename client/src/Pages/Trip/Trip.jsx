    ...
    <div>
      ...
      <div id="mytripflex">
        <div id="mytriphero">
          ...
          <Link to='/login'>
          <input type="text" placeholder='Log in to my account' id='mytripinput'/>
          </Link>
          <BiChevronRight id='inputiconleft'/>
          <Link to='/loginbooking'>
          <p id='tripbooking'>Log in with booking details <BiChevronRight id='bookingicon'/></p>
          </Link>
          ...
          <Link to='/signup'>
          <input type="text" placeholder='Create an account' id='mytripinput'/>
          </Link>
          <BiChevronRight id='inputiconleft'/>
        </div>
        <div>
